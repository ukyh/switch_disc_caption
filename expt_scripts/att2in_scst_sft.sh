...
# fine-tune
python -u tools/fine_tune.py --id ${ID} --id_old a2i2_sc-best --caption_model poe_a2i2 --max_epochs 1 --batch_size 10 --learning_rate ${LR} --start_from saved_models/att2in_scst --checkpoint_path saved_models/${ID} --simple_ft
