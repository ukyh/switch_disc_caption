...
ID=updown_scst_wft_bpdec
LR=1e-4
TMP=1

# fine-tune
python -u tools/fine_tune.py --id ${ID} --id_old tds_sc-best --caption_model poe_butd --max_epochs 1 --batch_size 10 --learning_rate ${LR} --start_from saved_models/updown_scst --checkpoint_path saved_models/${ID} --poe_temp ${TMP}
