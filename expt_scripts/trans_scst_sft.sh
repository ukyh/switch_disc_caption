...
# fine-tune
python -u tools/fine_tune.py --id ${ID} --id_old trans_scl-best --caption_model poe --max_epochs 1 --batch_size 10 --learning_rate ${LR} --start_from saved_models/trans_scst --checkpoint_path saved_models/${ID} --simple_ft
